...
data class BindHotelResponse(
    val code: Int,
    val message: String,
    val result: BindHotelResult,
    val success: Boolean,
    val timestamp: Long
)

data class BindHotelResult(
    val current: Int,
    val hasNext: Boolean,
    val pages: Int,
    val records: List<BindHotelResultRecord>,
    val size: Int,
    val total: Int
)

data class BindHotelResultRecord(
